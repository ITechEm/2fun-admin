...
export default function ProductForm({
  ...
  inStock: existingInStock, // Added inStock property
}) {
  ...
  const [inStock, setInStock] = useState(existingInStock || true); // Added state for in stock
 ...
 const data = {
  ...
  inStock, // Ensure inStock is included
};
  try {
    if (_id) {
